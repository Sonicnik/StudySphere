...
struct DetailPage: View {
    ...
    var body: some View {
        List {
            ...
            Section(header: Text(NSLocalizedString("Section", comment: "Section header"))) {
                HStack {
                    ...
                    Spacer()
                    Text(info.formats == .customize ? info.customFormat : NSLocalizedString(info.formats.rawValue, comment: "Format name"))
                        .padding(.trailing)
                }
                .padding()
        ...
        navigationTitle(NSLocalizedString("Subjects.\(info.subjects.rawValue)", comment: "Subject name") + "-" + (info.formats == .customize ? info.customFormat : NSLocalizedString(info.formats.rawValue, comment: "Format name")))
        .toolbar {
